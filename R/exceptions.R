...
SharekhanException <- condition(c("SharekhanException", "error"),
...
sharekhan_error_msg = "Sharekhan: Error"
is_sharekhan_error <- function(x){
  return(length(grep(sharekhan_error_msg,x))>0)
}
